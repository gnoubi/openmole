...
object Method extends PluginDefaults {
  ...
  lazy val all = Project("core-plugin-method", dir) aggregate (evolution, sensitivity, abc)
  ...
  lazy val abc = OsgiProject("abc") dependsOn (Core.implementation, Misc.exception, breeze)
